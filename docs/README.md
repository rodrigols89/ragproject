...
## Conteúdo
 ...
 - [`Implementando a exclusão de um arquivos (soft delete)`](#implementing-delete-file-soft-delete)
<!---
[WHITESPACE RULES]
...
Antes de partir para a implementação das views nós vamos precisar criar algumas `dataclasses`.
...
## `Implementando a exclusão de um arquivos (soft delete)`
